    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light" id="mainNav">
            <div class="container px-4 px-lg-5">
                <a class="navbar-brand" href="{{ route('home') }}">Newsletter</a>
        ...
        <!-- Page Header-->
        <header class="masthead" style="background-image: url('{{ asset('frontend/bg.jpg')}}');">
            ...
            <div class="row gx-4 gx-lg-5 justify-content-center">
                <div class="col-md-10 col-lg-8 col-xl-7">
                    ...
                    <div class="post-preview">
                        <a href="{{ route('newsletters.details', $newsletter->id) }}">
                            <h2 class="post-title">{{$newsletter->title }}</h2>
                            <div class="row">
